  ...
  return (
    <div className="flex flex-col h-screen mx-auto max-w-xl font-sans bg-white">
      ...
      <div className="flex gap-2 p-4 border-t border-gray-200 bg-gray-100 rounded-b-3xl">
        <input type="text" value={input} onChange={(e) => {setInput(e.target.value)}} className="w-full border-2 border-gray-300 rounded-md text-black px-2" />
        <button type="button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold p-2 rounded-full">
          <Image className="text-white" alt="Up arrow" width={32} height={32} src={ArrowUp} />
        </button>
        <button type="button" className="hover:bg-gray-400 px-2 rounded-full">
          {recording ?
